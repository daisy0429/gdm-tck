...
Feature: ListComprehensionAcceptance
  ...
  Scenario: [1] Should find all the variables in list comprehension
  ...
  Scenario: [2] Should handle list comprehension with AND and one NOT
    Given an empty graph
    And having executed:
        """
  ...
  Scenario: [3] Should handle list comprehension with AND and two NOT
    Given an empty graph
    And having executed:
        """
        CREATE (:Company {nbr: 1, status: 'ACTIVE'})
  ...
  Scenario: [4] Should handle list comprehension with OR and one NOT
    Given an empty graph
    And having executed:
        """
        CREATE (:Company {nbr: 1, status: 'ACTIVE'})
  ...
  Scenario: [5] Should handle list comprehension with OR and two NOT
    Given an empty graph
    And having executed:
        """
        CREATE (:Company {nbr: 1, status: 'ACTIVE'})
