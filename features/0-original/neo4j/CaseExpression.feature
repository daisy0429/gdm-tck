...
Feature: CaseExpression
  ...
  Scenario: [1] Case should handle mixed number types
    Given any graph
  ...
  Scenario: [2] Case should handle mixed types
    Given any graph
    When executing query:
      """
      WITH 0.5 AS x
  ...
  Scenario: [14] Shorthand case with filtering pattern comprehension should work as expected
    Given an empty graph
    And having executed:
      """
