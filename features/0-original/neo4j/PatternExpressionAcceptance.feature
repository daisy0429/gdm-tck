...
Feature: PatternExpressionAcceptance
  ...
  Scenario: [17] Returning pattern expression in `exists()`
    Given an empty graph
    And having executed:
      """
  ...
  Scenario: [19] Failing when introducing new node variable in pattern expression
    Given any graph
    When executing query:
      """
      MATCH (n)
  ...
  Scenario: [20] Failing when introducing new relationship variable in pattern expression
    Given any graph
    When executing query:
      """
      MATCH (n)
  ...
  Scenario: [24] [Modify] Nested pattern comprehensions
    Given an empty graph
    And having executed:
      """
  ...
  Scenario: [25] Nested pattern comprehensions 2
    Given an empty graph
    And having executed:
      """
  ...
  Scenario: [26] Nested pattern comprehensions 3
    Given an empty graph
    And having executed:
      """
      CREATE (:Artist {name:"Metallica"})-[:HAS_ALBUM]->(r:Album {name:"Reload"})-[:RECORDED_AT]->(s:Studio {name:"The Plant Studios in Sausalito"})
  ...
  Scenario: [27] Nested pattern comprehensions 4
    Given an empty graph
    And having executed:
      """
      CREATE (:Artist {name:"Metallica"})-[:HAS_ALBUM]->(r:Album {name:"Reload"})-[:RECORDED_AT]->(s:Studio {name:"The Plant Studios in Sausalito"})
  ...
  Scenario: [28] Nested pattern comprehension with food
    Given an empty graph
    And having executed:
    """
  ...
  Scenario: [29] Handling a null value in inner predicate
    Given an empty graph
    And having executed:
    """
