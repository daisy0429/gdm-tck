...
CLUSTER_BOLT_PORTS=("${GDM_CLUSTER_BOLT_PORT1:-7691}" "${GDM_CLUSTER_BOLT_PORT2:-7692}" "${GDM_CLUSTER_BOLT_PORT3:-7693}")

# ---- Metrics 端口（用于健康检查）----
STANDALONE_METRICS_ADDR="${GDM_STANDALONE_METRICS:-10.86.11.245:9095}"
CLUSTER_METRICS_ADDRS=("${GDM_CLUSTER_METRICS1:-10.86.11.245:9081}" "${GDM_CLUSTER_METRICS2:-10.86.11.245:9082}" "${GDM_CLUSTER_METRICS3:-10.86.11.245:9083}")
